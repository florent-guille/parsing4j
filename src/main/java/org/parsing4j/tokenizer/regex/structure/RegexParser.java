...
public class RegexParser {
	...
	private static Regex readTerm(CharFlow flow) throws Exception {
	...
	private static Regex readFactor(CharFlow flow) throws Exception {
	...
	private static Regex readBase(CharFlow flow) throws Exception {
		if (flow.peek() == '(') {
			flow.eat('(');
	...
	private static int readChar(CharFlow flow) throws Exception {
		if (flow.peek() == '\\') {
			flow.eat('\\');
	...
	private static Regex readLitteral(CharFlow flow) throws Exception {
	...
	private static String readLitteralName(CharFlow flow) throws Exception {
		flow.eat('\'');
	...
	private static int readNumber(CharFlow flow) throws Exception {
		int code = 0;
		int base = 10;
